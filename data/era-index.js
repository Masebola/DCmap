export const ERA_INDEX = [
  ...
  { id:'rebirth', label:'Rebirth → Metal', dates:'2016–2017', format:'legacy', loader:()=>import('./eras/rebirth/index.js') },
  { id:'post-metal', label:'Post-Metal → IF', dates:'2017–2021', format:'legacy', loader:()=>import('./eras/post-metal/index.js') },
  { id:'if-dc', label:'Infinite Frontier', dates:'2021–2023', format:'legacy', loader:()=>import('./eras/infinite-frontier/index.js') },
  { id:'dod', label:'Dawn of DC', dates:'2023–2024', format:'legacy', loader:()=>import('./eras/dawn-of-dc/index.js') },
  { id:'allin', label:'All In', dates:'2024–2026', format:'legacy', loader:()=>import('./eras/all-in/index.js') }
];
